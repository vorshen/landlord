...
我们这里偷了懒，首页和大厅页没有用canvas，直接上了dom，写起来也很奔放，没有用框架。如果游戏想正式一点，千万不要这样。看起来首页和大厅页逻辑很简单，那是因为我们漏掉了很多点（真的是时间不够啊）。

用一张图表现一下，我们漏掉的点：
![demo和正式游戏的差异](./img/17.png)

我们这么简单的情况下，如果说还有什么需要注意的，可能就两点
...
**如果当遇到，某一个场景很负责，切换需要较大的开销，可以考虑提前进行一些初始化的工作。**
